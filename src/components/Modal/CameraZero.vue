    ...
    <Dialog as="div" class="relative z-50">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        ...
        >
          ...
          >
            <DialogPanel
              class="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white px-8 pb-6 text-left align-middle shadow-xl transition-all"
            >
              <DialogTitle
                as="h3"
...
<!--              </div>-->
              ...
              <div class="pt-4">You don't have any location. Do you want to create?</div>

              <div class="flex justify-center mt-4">
                <BaseButton @click="createZeloLocation" title="Create location" rounded outline />
              </div>
            </DialogPanel>
          </TransitionChild>
        </div>
